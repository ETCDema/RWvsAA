define(function()
{
	...
	var DmSyntax				= {
		...
		{
			return _JSlikeSyntax(code, 'function|case|if|return|new|switch|var|this|typeof|for|in|while|break|do|continue|null|true|false', decorators.JS, decorator);
		},
		CS: function(code, decorator)
		{
			return _JSlikeSyntax(code, 'public|private|protected|internal|virtual|override|class|using|namespace|void|is|as|string|'+
											'int|float|double|decimal|foreach|object|enum|interface|static|base|null|case|if|return|new|'+
											'switch|var|this|typeof|for|in|while|break|do|continue|get|set|true|false|value|out|default|else', decorators.CS, decorator);
		},
		XML: function(xml, decorator)
		{
			decorator			= Object.assign({}, decorators.XML, decorator);	// Строим объект декоратора
		...
		{
			decorator			= Object.assign({}, decorators.CSS, decorator);	// Строим объект декоратора
		...
		{
			decorator			= Object.assign({}, decorators.HTML, decorator);	// Строим объект декоратора
	...
	function _JSlikeSyntax(code, keywords, decorator1, decorator2)
	{
		var decorator			= Object.assign({}, decorator1, decorator2);	// Строим объект декоратора
		...
		code					= makeSafe(TrueTabs(correctRN(code)))
								...
								.replace(new RegExp('\\b('+keywords+')\\b', 'g'),
									decorator.kw('$1'))
								// Выделяем скобки
								.replace(/(\{|\}|\]|\[|\|)/gi,
									decorator.gly('$1'))
	...
	decorators.CS				= Object.assign({}, decorators.JS, {
